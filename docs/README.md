...
6. Schema colável: [`database/schema.dbml`](database/schema.dbml) (dbdiagram.io)
7. ADRs relacionados: [0002](adr/0002-postgres-supabase-multi-tenant-rls.md), [0003](adr/0003-data-driven-risk-matrix.md), [0004](adr/0004-immutable-versioning-and-freeze.md), [0005](adr/0005-nonconformity-as-response-state.md), [0006](adr/0006-normalized-tenancy.md)
